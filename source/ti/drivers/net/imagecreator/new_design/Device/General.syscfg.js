...
let config = [
			...
			},
			{
				...
				longDescription : "Automatically obtain connected device's MAC address to create development mode image. If unchecked, specify the MAC address for the target you would like to create an image for.",
				default     : true,
				hidden      : false,
				onChange: (inst, ui) => {
			...
			},
			{
				...
				description : "Change Device's MAC Address after boot. Use this field if you want a different MAC Address than the device's hardware default",
				default     : true,
				onChange: (inst, ui) => {
			...
			},
			{
				...
				description : "This modified MAC address will take effect after the first successful flashing of the device.",
