			...
			config: [ 
					...
					config: [
								{
									...
									onChange: (inst, ui) => {
										...
										ui.OUTPUT_PAD.hidden = (inst.COEX_MODE == "0");
									}
								},
								{
									name        : "INPUT_PAD",
									displayName : "CC_COEX_BLE_IN Pad (GPIO) (PIN)",
									//default     : "04",
									default     : cc31 ? "09":"04",
									hidden      : true,
									options     :[
								...
								{
									name        : "OUTPUT_PAD",
									displayName : "CC_COEX_SW_OUT Pad (GPIO) (PIN)",
									default     : cc31 ? "12":"03",
									hidden      : true,
									options     :[
													{name : "00" ,displayName : "   PAD00 (00) (50)"	},
				...
				{ //Ant Sel
					...
					config: [
								...
								{
									name        : "ANT1_PAD",
									displayName : "ANT_SEL_1 Pad (GPIO) (PIN)",
									default     : cc31 ? "28":"08",
									hidden      : true,
									options     :[
													{name : "03" ,displayName : "   PAD03 (03) (58)"	},
								...
								{
									name        : "ANT2_PAD",
									displayName : "ANT_SEL_2 Pad (GPIO) (PIN)",
									default     : cc31 ? "10":"09",
									hidden      : true,
									options     :[
